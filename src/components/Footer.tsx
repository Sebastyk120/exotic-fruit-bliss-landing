        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#productos" className="text-gray-400 hover:text-primary transition-colors">Frutas Tropicales</a></li>
              <li><a href="#productos" className="text-gray-400 hover:text-primary transition-colors">Frutas Exóticas</a></li>
              <li><a href="#productos" className="text-gray-400 hover:text-primary transition-colors">Packs Gourmet</a></li>
              <li><a href="#productos" className="text-gray-400 hover:text-primary transition-colors">Para Distribuidores</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#nosotros" className="text-gray-400 hover:text-primary transition-colors">Sobre Nosotros</a></li>
              <li><a href="#productos" className="text-gray-400 hover:text-primary transition-colors">Productos</a></li>
