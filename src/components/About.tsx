...
const About = () => {
  return (
    <section id="nosotros" className="bg-gradient-to-b from-white to-gray-50 section-padding">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="relative">
            <div className="absolute -top-6 -left-6 w-24 h-24 rounded-full bg-tertiary/10 animate-pulse"></div>
            <img 
              src="/lovable-uploads/059a815e-f40f-4004-a39a-4a154d26d68b.png" 
              alt="L&M Exotic Fruits" 
              className="rounded-lg shadow-lg relative z-10"
            />
            <div className="absolute -bottom-6 -right-6 bg-white rounded-lg shadow-lg px-6 py-4 border-l-4 border-accent">
              <p className="text-primary font-bold">Desde 2017</p>
            </div>
          </div>
          
          <div>
            <h3 className="text-2xl font-bold mb-4 gradient-text inline-block">L&M Exotic Fruits</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-md border-t-4 border-primary hover:shadow-lg transition-all">
              ...
              <div className="bg-white p-4 rounded-lg shadow-md border-t-4 border-secondary hover:shadow-lg transition-all">
